...
const SliderProductMonth = ({ products, onAddProductClass, onAddCart, onRemovCart, onUpdateCountTotalPlus, onUpdateCountTotalMinus, titel }) => {
...
export default SliderProductMonth;