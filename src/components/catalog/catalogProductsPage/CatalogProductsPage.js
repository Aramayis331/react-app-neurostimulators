...
const CatalogProductsPage = ({ productsPage, onAddProductClass, onAddCart, onRemovCart, onUpdateCountTotalPlus, onUpdateCountTotalMinus, objProductStyle, productsPerPage, pagination, currentPage, onChangePaginationPage, catalogProducts }) => {

	return (
	<div>
		{ (catalogProducts.length === 0)  && (<div className='productsCartEmpty'>Сейчас нет такого продукта</div>)}
		<div className='catalogProductsPage'>
			{
